...
ENDPOINT_NAME = "llama-3-2-1b-provisioned-kirancr2"  # Your endpoint name
...
def get_endpoint_metrics(endpoint_name: str):  # noqa: ANN201
...
def estimate_provisioned_cost(  # noqa: ANN201
    model_units: int,
    hours_per_day: int,
    days: int,
...
def delete_endpoint(endpoint_name: str):  # noqa: ANN201
    try:
